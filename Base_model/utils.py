...
def Feature(data,args):
    ...
    for i in range(len(data)):
        #input_data_spec.append(data[i]['Data_label'].reshape(-1,1))
        input_data_spec.append(data[i]['fea_data'])
    ...
    return input_data_spec_CNN,input_data_spec_CNN,input_label,input_data_id,input_label_org
